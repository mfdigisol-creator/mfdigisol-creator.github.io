...
if (!hasStylesheet('catalogue.css')) insertBefore('</head>', '    <link rel="stylesheet" href="catalogue.css" />\n  ', 'document head');
...
if (!hasStylesheet('commerce.css')) insertBefore('</head>', '    <link rel="stylesheet" href="commerce.css" />\n  ', 'document head');
...
console.log(`Catalogue integration installed; index.html is ${Buffer.byteLength(html).toLocaleString()} bytes.`);
