(() => {
  ...
  function showConsent(){
    ...
    const style=document.createElement('style'); style.textContent='.consent-banner{position:fixed;z-index:120;left:1rem;right:1rem;bottom:1rem;display:flex;align-items:center;justify-content:space-between;gap:1rem;max-width:920px;margin:auto;padding:1rem 1.15rem;border:1px solid #DDD5C7;background:#F8F5EF;color:#171717;box-shadow:0 18px 60px rgba(31,33,31,.18);font:14px/1.5 Arial,sans-serif}.consent-banner p{margin:0;max-width:600px}.consent-banner a{color:#171717;text-decoration-color:#B08A4A}.consent-actions{display:flex;flex-wrap:wrap;gap:.55rem}.consent-actions button{min-height:42px;padding:.65rem .9rem;border:1px solid #1F211F;background:transparent;color:#1F211F;cursor:pointer}.consent-actions [data-consent-accept]{background:#1F211F;color:#F8F5EF}@media(max-width:700px){.consent-banner{align-items:stretch;flex-direction:column}.consent-actions{display:grid;grid-template-columns:1fr 1fr}.consent-actions button{width:100%}}'; document.head.append(style);
